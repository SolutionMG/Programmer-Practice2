...
namespace RenderMessageMacro
{
	...
	constexpr char ROOM_ENTER_FAILED_MESSAGE[] = "** <입장 실패> 존재하지 않는 방입니다. 올바른 방 번호를 입력해주세요.\n\r";
	constexpr char ROOM_ENTER_FULLMESSAGE[] = "** <입장 실패> 해당 방은 이미 최대 인원입니다. 다른 방을 이용해주세요.\n\r";
...
namespace SearchMacro
{
	...
	TCHAR ROOM_ENTERFAILED[] = L"<입장 실패>";
	TCHAR ROOM_ENTER[] = L"<입장>";

	TCHAR SECRET_MESSAGE[] = L"<귓속말>";

	TCHAR ROOMINFO_SUCCESS[] = L"<방 정보>";
